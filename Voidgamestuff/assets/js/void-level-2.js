// =============================================================
//  V.O.I.D.EXE  —  void-level-2.js  (ES Module)
// =============================================================
import { registerLevel, buildBorderWalls, rectWall, COLS, ROWS, CELL } from './void-core.js';

registerLevel({
  walls: buildBorderWalls(COLS, ROWS).concat([
    ...rectWall(5, 2, 2, 12), ...rectWall(15, 2, 2, 12),
  ]),
  start: { x: 2, y: 7 },

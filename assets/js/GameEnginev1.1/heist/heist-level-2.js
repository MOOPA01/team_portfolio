...
registerLevel(HEIST_LEVEL_2_DATA);

export const HEIST_LEVEL_2 = HEIST_LEVEL_2_DATA;

export default class HeistLevel2 {
  constructor(gameEnv) {
    this.gameEnv = gameEnv;
    this.levelData = HEIST_LEVEL_2_DATA;
    this.classes = [];
    this.meta = { title: 'SECURITY HUB', difficulty: 'OPERATIVE' };
  }
